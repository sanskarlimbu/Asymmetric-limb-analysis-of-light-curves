...
def main(times:np.ndarray, fluxes:np.ndarray, tp: TransitParams, u, ephase, iphase):
    '''
    Produces the supposed raddi of ingress and egress portions by curvefitting cut up light curves
    Also returns the linear trend (retroactively added to plot this)
    '''
    # Remove nans
